...
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'netrw',
  callback = function()
    vim.api.nvim_buf_set_keymap(0, 'n', '<C-l>', '<C-q>', { noremap = true, silent = true })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      --
      -- LSP is an initialism you've probably heard, but might not understand what it ism
      --
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'go', 'c_sharp', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
